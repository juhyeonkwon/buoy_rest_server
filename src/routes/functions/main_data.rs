...
pub fn get_near_obs_data(db : &mut DataBase, conn : &mut redis::Connection, lat : &f64, lon : &f64) -> Value {
...
pub fn get_near_wave_data(db : &mut DataBase, conn : &mut redis::Connection, lat : &f64, lon : &f64) -> Value {
...
pub fn get_near_tide_data(db : &mut DataBase, conn : &mut redis::Connection, lat : &f64, lon : &f64) -> Value {
...
fn get_neareast_hf<'a>(list : &'a Vec<TideRader>) -> &'a TideRader {
